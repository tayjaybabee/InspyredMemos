...
File: 
    inspyred_memo_server/utils/decorators.py
...
def property_alias(alias_name: str, original_name: str):
    def decorator(cls):
        original = getattr(cls, original_name)
        setattr(cls, alias_name, property(original.fget, original.fset))
        return cls
    return decorator
